...
## 4. Вывести на экран зашифрованный пароль

```bash
openssl enc -d -aes-256-cbc -md sha512 -a -pbkdf2 -iter 100000 -salt -pass pass:$F -in /usr/local/share/passwd/secret_border.txt
```
